...
public class PreguntaCinco extends Pregunta {	
	...
	public PreguntaCinco(int codigo,String enunciado,String s0,String s1,String s2,String s3,String s4) throws Exception {
		this(codigo,enunciado,new Respuesta(0,s0),new Respuesta(1,s1),new Respuesta(2,s2),new Respuesta(3,s3),new Respuesta(4,s4));
	}
